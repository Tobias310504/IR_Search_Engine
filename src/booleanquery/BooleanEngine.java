...
public class BooleanEngine {
    ...
    public Set<Integer> search(String query, Set<Integer> allDocumentIds) {
        QueryExpression expression = parser.parse(query);//Parse query menjadi QueryExpression
        return expression.evaluate(index, allDocumentIds);//Evaluate expression dan return hasil doc_id
    }
}